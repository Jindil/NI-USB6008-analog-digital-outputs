...
# Create 1 Task object per pin
List_Task  = [BitTask1,BitTask2,VTask1,VTask2] = [Task() for i in range(4)]
List_Bit   = [BitTask1,BitTask2]
List_Volt  = [VTask1, VTask2]

# Assign Bit Task to digital pins
BitTask1.CreateDOChan("Dev1/port1/line0","BitTask1",DAQmx_Val_ChanPerLine) # this is digital pin0 of port1 on Device 1
BitTask2.CreateDOChan("Dev1/port1/line1","BitTask2",DAQmx_Val_ChanPerLine) # this is digital pin1 of port1 on Device 1

# Assign Vtask to analogue pin
VTask1.CreateAOVoltageChan("Dev1/ao0","VTask1",0,5,DAQmx_Val_Volts,None) # This is analogue pin 0 of Device 1
VTask2.CreateAOVoltageChan("Dev1/ao1","VTask2",0,5,DAQmx_Val_Volts, None) # This is analogue pin 1 of Device 1
...
def Voltage(MyVTask, Percentage):
    '''Apply voltage (in % : 100% = 5V) to an analogue pin corresponding to the provided task'''
...
def Reset():
    ...
    for i in List_Bit:
        i.WriteDigitalLines(1,1,-1,DAQmx_Val_GroupByChannel,Num0,None,None)
